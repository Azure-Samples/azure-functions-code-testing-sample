...
The API uses **Azure Cosmos DB** to store the created Notes and to run it locally you must run your API against a local instance of **Azure CosmosDB emulator**. 
